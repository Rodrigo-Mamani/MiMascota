...
<head>
        ...
        <title>MiMascota! © - Preguntas frecuentes</title>
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-10 my-5">
                  <div id="preguntas" style="color: #9ACD32;">Preguntas frecuentes:</div><br>

                  <h4 style="color: #9ACD32;">¿Qué es "Mi mascota"?<br></h4>
                  <p class="respuesta">R: Es una red social multifuncional dirigida y desarrollada para las personas que quieren dar a conocer a sus mascotas o que simplemente busquen a alguien que comparta su interés por los animales.<br></p>

                  <h4 style="color: #9ACD32;">¿Para qué sirve?<br></h4>
                  ...
                  <h4 style="color: #9ACD32;">¿Se me cobrará por usar Mi mascota?<br></h4>
                  ...
                  <h4 style="color: #9ACD32;">¿Cómo dejo de recibir noticaciones?<br></h4>
